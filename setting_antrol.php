...
if (isset($_POST['simpan'])) {
    ...
    if($cons_id && $secret_key && $user_key && $base_url){
        try {
            ...
            $success = "✔ Setting Antrol BPJS berhasil diperbarui!";
            $data = $pdo->query("SELECT * FROM setting_antrol LIMIT 1")->fetch(PDO::FETCH_ASSOC);
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="welcome-box">
        <h3><i class="fa fa-link"></i> Setting Antrol BPJS Kesehatan</h3>
        <p>Konfigurasi bridging Antrean Online BPJS Kesehatan</p>
      </div>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <form method="post">
                ...
                <div class="form-group">
                  <button type="submit" name="simpan" class="btn btn-primary btn-save-custom">
